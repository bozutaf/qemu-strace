...
#define TARGET_TIOCGPKT        TARGET_IOR('T', 0x38, int) /* Get packet mode state */
#define TARGET_TIOCGPTLCK      TARGET_IOR('T', 0x39, int) /* Get Pty lock state */
#define TARGET_TIOCGEXCL       TARGET_IOR('T', 0x40, int) /* Get exclusive mode state */
